 ...
 * (기존 JS 구현과 동일한 내용)
 */
export function getNoInternalMonologueRules() {
...
export function getPlanFormatRules() {
...
export function getMultiFileReadRules() {
    return `**다중 파일 읽기 (중요):**
...
export function getNoDuplicateReadRules() {
 ...
 */
export function getLargeFileChunkReadingRules() {
...
export function getFileCreationContext() {
    return `**⚠️ 중요 컨텍스트:**
 ...
 */
export function getFileExistenceCheckRules() {
...
export function getNoThinkingLeakageRules() {
...
// ==================== File Operations ====================
export function getFileOperationsRules() {
    return `파일 작업 형식:
...
// ==================== Code vs Script ====================
export function getCodeVsScriptRules() {
...
// ==================== Code Generation ====================
export function getCodeGenerationGuide() {
    return `코드 생성/수정 지침:
...
// ==================== Error Correction ====================
export function getErrorCorrectionGuide() {
    return `에러 수정 지침:
 ...
 */
export function getToolsPrompt(allowedTools) {
    return ToolSpecBuilder.buildToolPromptSectionJson(allowedTools);
}
// ==================== Terminal Commands ====================
export function getTerminalCommandRules(shellType) {
...
export function getCommandExecutionGuide() {
    return `명령 생성 지침:
...
export function buildShellSpecificPrompt(shellType) {
