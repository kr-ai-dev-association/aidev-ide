 ...
 */
import { getNoInternalMonologueRules, getPlanFormatRules, getMultiFileReadRules, getNoDuplicateReadRules, getNoThinkingLeakageRules, getFileExistenceCheckRules, getLargeFileChunkReadingRules, } from "./base";
// ==================== Intent Phase ====================
...
// ==================== Investigation Phase ====================
export function getInvestigationPrompt(userQuery) {
...
// ==================== Execution Phase ====================
export function getExecutionPhasePrompt() {
    const noMonologueRules = getNoInternalMonologueRules();
    const noThinkingLeakage = getNoThinkingLeakageRules();
    const fileExistenceRules = getFileExistenceCheckRules();
    return (`\n\n⚠️ **실행 단계 - 절대 규칙 (예외 없음)**\n\n` +
