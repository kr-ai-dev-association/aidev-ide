 ...
 * 일반 질의응답 프롬프트
 */
export function getGeneralAskPrompt(options) {
    const { codebaseContext = "", profileContext = "", intentContext = "", realTimeInfo = "", gitContext = "", languageInstruction = "", selectedFilesContent = "", terminalContextContent = "", diagnosticsContextContent = "", } = options;
...
//# sourceMappingURL=generalAsk.js.map