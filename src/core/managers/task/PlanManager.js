...
import { getSplitInstructionPrompt, getSplitInstructionSystemPrompt, getStructuredPlanPrompt, getLegacyPlanPrompt, getSummarizePlanPrompt, getSummarizePlanSystemPrompt } from '../context/prompts/plan';
export class PlanManager {
    static instance;
    llmService;
    currentModelType = AiModelType.GEMINI;
    constructor() {
