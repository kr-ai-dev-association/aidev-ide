...
export class FileTransactionManager {
     ...
     */
    async recordFileChange(filePath, afterContent) {
        if (!this.activeTransaction) {
     ...
     * 파일 적용 완료 표시
     */
    markFileApplied(filePath, afterContent) {
        if (!this.activeTransaction) {
            return;
        }
...
//# sourceMappingURL=FileTransactionManager.js.map