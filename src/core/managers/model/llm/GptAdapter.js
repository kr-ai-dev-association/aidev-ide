import { LLMFeature, } from './ILLMAdapter';
import { AiModelType } from '../../../../services';
import { PromptComposer } from '../../context/prompts/PromptComposer';
import { getAgentRole, getCodeGenerationGuide, getErrorCorrectionGuide, getCommandExecutionGuide, buildShellSpecificPrompt, getDefaultOutputFormat, } from '../../context/prompts/base';
/**
 * GPT LLM 어댑터
