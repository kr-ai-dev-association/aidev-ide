 ...
 * LLM이 자주 사용하는 추론 문구들
 */
export const THINKING_PATTERNS_EN: RegExp[] = [
    // 의도/계획 표현
    /\bWe should\b/i,
    /\bWe need to\b/i,
    /\bWe must\b/i,
 ...
 * 한국어 thinking 패턴
 */
export const THINKING_PATTERNS_KO: RegExp[] = [
    // 의도/계획 표현
    /먼저.*해야/,
    /우선.*해야/,
    /해야\s*합니다/,
 ...
 */
export const ALL_THINKING_PATTERNS: RegExp[] = [
 ...
 */
export function hasThinkingPattern(text: string): boolean {
