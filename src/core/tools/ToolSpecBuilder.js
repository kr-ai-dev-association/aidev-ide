...
export class ToolSpecBuilder {
     ...
     * MCP 도구 스펙 생성
     */
    static buildMCPToolSpecs() {
        const registry = ToolRegistry.getInstance();
        const mcpHandlers = registry.getMCPTools();
        return mcpHandlers
            .filter((h) => h instanceof MCPToolHandler)
            .map(handler => {
     ...
     */
    static buildFunctionDeclarations(allowedTools) {
     ...
     */
    static specToFunctionDeclaration(spec) {
        const properties = {};
        const required = [];
     ...
     */
    static buildToolPromptSectionJson(allowedTools) {
        const specs = this.buildToolSpecs(allowedTools);
     ...
     */
    static buildGeminiToolsConfig(allowedTools) {
        return {
     ...
     */
    static buildOpenAIToolsConfig(allowedTools) {
