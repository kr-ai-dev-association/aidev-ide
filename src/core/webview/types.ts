...
export interface GetAgentPolicyCommand {
    command: 'getAgentPolicyStableVersion' | 'getAgentPolicyCodingStyle'
        | 'getAgentPolicyProjectArchitecture' | 'getAgentPolicyDependencyPolicy'
 ...
 */
export type MessageByCommand<T extends WebviewMessage, C extends string> =
