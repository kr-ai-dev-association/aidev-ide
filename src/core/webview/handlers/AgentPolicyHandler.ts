    ...
    switch (data.command) {
        ...
        try {
          ...
          if (mdContent && typeof mdContent === "string") {
            ...
            notificationService.showInfoMessage(
              `CODEPILOT-STANDALONE: Stable Version Markdown saved to ${filePath}`,
            );
          } else {
            safePostMessage(panel, {
      ...
      case "uploadAgentPolicyCodingStyle": // Coding Style Markdown 저장
        try {
          ...
          if (mdContent && typeof mdContent === "string") {
            ...
            notificationService.showInfoMessage(
              `CODEPILOT-STANDALONE: Coding Style Markdown saved to ${filePath}`,
            );
          } else {
            safePostMessage(panel, {
      ...
      case "uploadAgentPolicyProjectArchitecture": // Project Architecture Markdown 저장
        try {
          ...
          if (mdContent && typeof mdContent === "string") {
            ...
            notificationService.showInfoMessage(
              `CODEPILOT-STANDALONE: Project Architecture Markdown saved to ${filePath}`,
            );
          } else {
            safePostMessage(panel, {
      ...
      case "uploadAgentPolicyDependencyPolicy": // Dependency Policy Markdown 저장
        try {
          ...
          if (mdContent && typeof mdContent === "string") {
            ...
            notificationService.showInfoMessage(
              `CODEPILOT-STANDALONE: Dependency Policy Markdown saved to ${filePath}`,
            );
          } else {
            safePostMessage(panel, {
      ...
      case "uploadAgentPolicyDbPolicy": // DB Policy Markdown 저장
        try {
          ...
          if (mdContent && typeof mdContent === "string") {
            ...
            notificationService.showInfoMessage(
              `CODEPILOT-STANDALONE: DB Policy Markdown saved to ${filePath}`,
            );
          } else {
            safePostMessage(panel, {
      ...
      case "deleteAgentPolicyStableVersion": // Stable Version Markdown 삭제
        try {
          ...
          notificationService.showInfoMessage(
            "CODEPILOT-STANDALONE: Stable Version Markdown deleted.",
          );
        } catch (error: any) {
          safePostMessage(panel, {
      ...
      case "deleteAgentPolicyCodingStyle": // Coding Style Markdown 삭제
        try {
          ...
          notificationService.showInfoMessage(
            "CODEPILOT-STANDALONE: Coding Style Markdown deleted.",
          );
        } catch (error: any) {
          safePostMessage(panel, {
      ...
      case "deleteAgentPolicyProjectArchitecture": // Project Architecture Markdown 삭제
        try {
          ...
          notificationService.showInfoMessage(
            "CODEPILOT-STANDALONE: Project Architecture Markdown deleted.",
          );
        } catch (error: any) {
          safePostMessage(panel, {
      ...
      case "deleteAgentPolicyDependencyPolicy": // Dependency Policy Markdown 삭제
        try {
          ...
          notificationService.showInfoMessage(
            "CODEPILOT-STANDALONE: Dependency Policy Markdown deleted.",
          );
        } catch (error: any) {
          safePostMessage(panel, {
      ...
      case "deleteAgentPolicyDbPolicy": // DB Policy Markdown 삭제
        try {
          ...
          notificationService.showInfoMessage(
            "CODEPILOT-STANDALONE: DB Policy Markdown deleted.",
          );
        } catch (error: any) {
          safePostMessage(panel, {
      ...
      case "deleteAgentPolicyFile": // 카테고리에서 특정 파일 삭제
        try {
          ...
          notificationService.showInfoMessage(
            `CODEPILOT-STANDALONE: ${targetFileName} deleted`,
          );
        } catch (error: any) {
