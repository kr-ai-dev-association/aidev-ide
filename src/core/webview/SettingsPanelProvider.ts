      ...
      switch (data.command) {
        case "getCurrentSettings": {
          try {
            ...
            // 확장 버전 로드 (context에서)
            const extension =
              vscode.extensions.getExtension("banya.agentgocoder");
          ...
          try {
            ...
            if (compactorType) {
              ...
              const modelInfo = compactorModelName
                ...
                : "";
              notificationService.showInfoMessage(
                `AgentGoCoder: Compactor 모델이 ${typeLabel}${modelInfo}로 설정되었습니다.`,
              );
            } else {
              safePostMessage(panel, {
        ...
        case "saveCompactorApiKey": // Compactor API 키 저장
          try {
            ...
            if (compactorApiKey) {
              ...
              notificationService.showInfoMessage(
                `AgentGoCoder: Compactor ${typeLabel} API 키가 저장되었습니다.`,
              );
            } else {
              safePostMessage(panel, {
        ...
        case "clearCompactorModel": // Compactor 모델 초기화
          try {
            ...
            notificationService.showInfoMessage(
              "AgentGoCoder: Compactor 모델이 초기화되었습니다. 메인 모델이 사용됩니다.",
            );
          } catch (error: any) {
            safePostMessage(panel, {
          ...
          try {
            ...
            if (commandType) {
              ...
              const modelInfo = commandModelName
                ...
                : "";
              notificationService.showInfoMessage(
                `AgentGoCoder: Command 모델이 ${typeLabel}${modelInfo}로 설정되었습니다.`,
              );
            } else {
              safePostMessage(panel, {
        ...
        case "saveCommandApiKey": // Command API 키 저장
          try {
            ...
            if (commandApiKey) {
              ...
              notificationService.showInfoMessage(
                `AgentGoCoder: Command ${typeLabel} API 키가 저장되었습니다.`,
              );
            } else {
              safePostMessage(panel, {
        ...
        case "clearCommandModel": // Command 모델 초기화
          try {
            ...
            notificationService.showInfoMessage(
              "AgentGoCoder: Command 모델이 초기화되었습니다. 메인 모델이 사용됩니다.",
            );
          } catch (error: any) {
            safePostMessage(panel, {
        ...
        case "saveIntentModel": // Intent 모델 저장
          try {
            ...
            if (intentType) {
              ...
              notificationService.showInfoMessage(
                `AgentGoCoder: Intent 모델이 ${typeLabel}${modelInfo}로 설정되었습니다.`,
              );
            } else {
              safePostMessage(panel, {
        ...
        case "saveIntentApiKey": // Intent API 키 저장
          try {
            ...
            if (intentApiKey) {
              ...
              notificationService.showInfoMessage(
                `AgentGoCoder: Intent ${typeLabel} API 키가 저장되었습니다.`,
              );
            } else {
              safePostMessage(panel, {
        ...
        case "clearIntentModel": // Intent 모델 초기화
          try {
            ...
            notificationService.showInfoMessage(
              "AgentGoCoder: Intent 모델이 초기화되었습니다. 메인 모델이 사용됩니다.",
            );
          } catch (error: any) {
            safePostMessage(panel, {
        ...
        case "saveErrorFallbackModel": // 에러 폴백 모델 저장
          try {
            ...
            if (errorFallbackType) {
              ...
              notificationService.showInfoMessage(
                `AgentGoCoder: 에러 폴백 모델이 저장되었습니다.${modelInfo}`,
              );
            }
          } catch (error: any) {
            safePostMessage(panel, {
        ...
        case "saveErrorFallbackApiKey": // 에러 폴백 API 키 저장
          try {
            ...
            if (errorFallbackApiKey) {
              ...
              notificationService.showInfoMessage(
                "AgentGoCoder: 에러 폴백 모델 API 키가 저장되었습니다.",
              );
            }
          } catch (error: any) {
            safePostMessage(panel, {
        ...
        case "clearErrorFallbackModel": // 에러 폴백 모델 초기화
          try {
            ...
            notificationService.showInfoMessage(
              "AgentGoCoder: 에러 폴백 모델이 초기화되었습니다. 메인 모델이 사용됩니다.",
            );
          } catch (error: any) {
            safePostMessage(panel, {
        ...
        case "addHotLoad":
          try {
            ...
            notificationService.showInfoMessage(
              "AgentGoCoder: Hot Load 항목이 추가되었습니다.",
            );
          } catch (error: any) {
        ...
        case "updateHotLoad":
          try {
            ...
            notificationService.showInfoMessage(
              "AgentGoCoder: Hot Load 항목이 수정되었습니다.",
            );
          } catch (error: any) {
            console.error(
        ...
        case "deleteHotLoad":
          try {
            ...
            notificationService.showInfoMessage(
              "AgentGoCoder: Hot Load 항목이 삭제되었습니다.",
            );
          } catch (error: any) {
            console.error(
          ...
          try {
            ...
            const uri = await vscode.window.showSaveDialog({
              defaultUri: vscode.Uri.file(
                `agentgocoder-settings-${new Date().toISOString().slice(0, 10)}.json`,
              ),
              filters: { JSON: ["json"] },
            });
        ...
        case "importSettings": {
          try {
            ...
            const cfgImport = vscode.workspace.getConfiguration("agentgocoder");
