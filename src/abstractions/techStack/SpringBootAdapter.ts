...
import {
    ...
    ProjectMetadata,
    FileType,
} from './ITechStackAdapter';

/**
 * Spring Boot 기술 스택 어댑터
 */
export class SpringBootAdapter implements ITechStackAdapter {
    readonly stackId = 'spring-boot';
    readonly stackName = 'Spring Boot';
...
server:
  port: 8080`,
    ...
    suggestErrorFix(error: TechStackError): ErrorFixSuggestion | null {
