...
import { PromptType } from '../../services'; // PromptType 임포트
import { StateManager, TerminalManager, ConversationService, ExecutionManager } from '../../core';
export class AskViewProvider {
    extensionUri;
    context;
