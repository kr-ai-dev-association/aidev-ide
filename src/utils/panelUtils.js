 ...
 */
export function safePostMessage(webview, message) {
    try {
        if (webview) {
            try {
 ...
 */
export function getHtmlContentWithUris(extensionUri, htmlFileName, webview) {
 ...
 * 새 웹뷰 패널을 생성하고 설정합니다.
 */
export function createAndSetupWebviewPanel(extensionUri, contextForSubs, panelTypeSuffix, panelTitle, htmlFileName, viewColumn = vscode.ViewColumn.One, onDidReceiveMessage) {
