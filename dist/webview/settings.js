...
function _showSkillPreviewModal(data, onConfirm, onCancel) {
  ...
  box.style.cssText = "background:var(--vscode-editor-background,#1e1e1e);color:var(--vscode-foreground,#ccc);border:1px solid var(--vscode-input-border,#444);border-radius:6px;width:80%;max-width:820px;max-height:80vh;padding:16px;display:flex;flex-direction:column;gap:8px;font-family:var(--vscode-font-family);";
  ...
  metaRoot.style.cssText = "font-size:0.82em;color:var(--vscode-descriptionForeground);line-height:1.6;";
  ...
  if (Array.isArray(data.suspicious) && data.suspicious.length > 0) {
    ...
    warn.style.cssText = "background:rgba(245,158,11,0.18);border-left:3px solid #f59e0b;padding:8px;font-size:0.85em;";
  ...
  pre.style.cssText = "flex:1;overflow:auto;background:var(--vscode-textCodeBlock-background,#2a2a2a);padding:8px;margin:0;font-size:0.78em;max-height:45vh;border-radius:4px;white-space:pre;";
