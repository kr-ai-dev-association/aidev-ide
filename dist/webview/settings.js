...
function populateRoutingModelOptions() {
  const routingSelects = [document.getElementById('compactor-model-type-select'), document.getElementById('command-model-type-select'), document.getElementById('intent-model-type-select')];
  const aiModels = cachedServerSettings['ai_model'] || [];
...
function updateSaveButtonsState() {
  const allButtons = [saveSupportedModelApiKeyButton, saveLocalOllamaApiUrlButton, saveLocalOllamaEndpointButton, saveRemoteOllamaModelButton, saveRemoteOllamaApiUrlButton, saveRemoteOllamaEndpointButton, saveOllamaServerTypeButton, saveOllamaModelButton];
