...
class ErrorReportingService {
    ...
    async flush() {
        ...
        try {
            const { CodePilotApiClient } = await __webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(__webpack_require__, 706));
            const { AuthService } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 671));
