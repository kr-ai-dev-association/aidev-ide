...
exports.AskViewProvider = void 0;
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
const utils_1 = require("../../utils");
const services_1 = require("../../services"); // PromptType 임포트
...
class AskViewProvider {
    ...
    notificationService;
    static viewType = 'codepilot.askView'; // 새로운 뷰 타입
    _view;
    constructor(extensionUri, context, configurationService, notificationService) {
    ...
    resolveWebviewView(webviewView, context, _token) {
        ...
        // ASK 탭은 ask.html을 사용
        webviewView.webview.html = (0, utils_1.getHtmlContentWithUris)(this.extensionUri, 'ask', webviewView.webview);
            ...
            switch (data.command) {
                case 'sendMessage':
                    ...
                    await core_1.ConversationService.handleUserMessage({
                        ...
                        promptType: services_1.PromptType.GENERAL_ASK,
                ...
                case 'clearHistory':
                    ...
                    try {
                        await core_1.ConversationService.clearHistory(services_1.PromptType.GENERAL_ASK, this.context);
                        webviewView.webview.postMessage({
                            command: 'receiveMessage',
                            sender: 'CODEPILOT',
                            text: '대화기록이 삭제되었습니다.'
     ...
     */
    processGeneralAskResponse(llmResponse, webview) {
        let cleanedResponse = llmResponse;
        let hasWarnings = false;
        // 터미널 명령어 체크
        if (this.hasBashCommands(cleanedResponse)) {
            const warningMsg = "ASK 탭에서는 터미널 명령어를 실행할 수 없습니다. CODE 탭을 사용해주세요.";
            (0, utils_1.safePostMessage)(webview, { command: 'receiveMessage', sender: 'CODEPILOT', text: warningMsg });
        ...
        if (cleanedResponse.trim()) {
            (0, utils_1.safePostMessage)(webview, { command: 'receiveMessage', sender: 'CODEPILOT', text: cleanedResponse });
        }
    }
    /**
     * 터미널 명령어를 제거합니다.
...
exports.AskViewProvider = AskViewProvider;
//# sourceMappingURL=AskViewProvider.js.map