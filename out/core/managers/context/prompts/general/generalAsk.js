...
exports.getGeneralAskPrompt = getGeneralAskPrompt;
function getGeneralAskPrompt(options) {
    const { codebaseContext = '', profileContext = '', intentContext = '', realTimeInfo = '', gitContext = '', languageInstruction = '' } = options;
