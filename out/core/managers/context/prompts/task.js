...
exports.getCodeWorkPrompt = getCodeWorkPrompt;
exports.getExecutionWorkPrompt = getExecutionWorkPrompt;
exports.getSummarizationPrompt = getSummarizationPrompt;
exports.getSimpleSummaryPrompt = getSimpleSummaryPrompt;
// ==================== Code Work ====================
function getCodeWorkPrompt() {
...
// ==================== Execution Work ====================
function getExecutionWorkPrompt() {
...
// ==================== Summarize ====================
function getSummarizationPrompt(options, taskProgress) {
...
function getSimpleSummaryPrompt(createdFiles, modifiedFiles) {
    const fileListContext = (createdFiles.length > 0 ? `생성된 파일: ${createdFiles.join(', ')}\n` : '') +
