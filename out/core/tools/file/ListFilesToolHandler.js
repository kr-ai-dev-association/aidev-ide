...
exports.ListFilesToolHandler = void 0;
const types_1 = require("../types");
const fs = __importStar(require("fs/promises"));
const path = __importStar(require("path"));
class ListFilesToolHandler {
    ...
    async listFiles(dirPath, recursive, projectRoot) {
        const files = [];
        const self = this;
...
exports.ListFilesToolHandler = ListFilesToolHandler;
